file1=open("H:\GCSE\Computing\LogoArt.txt","r")
file2=open("H:\GCSE\Computing\LogoRLE.txt","r")
n = -1
m = -1
g = 6
List3 = []
...
def ReadFromFile(file2):
     file2=open("H:\GCSE\Computing\LogoRLE.txt","r") #w =write, r =read, a=append
...
def ReadFromFile2(file1):
     file1=open("H:\GCSE\Computing\LogoRLE.txt","r")
